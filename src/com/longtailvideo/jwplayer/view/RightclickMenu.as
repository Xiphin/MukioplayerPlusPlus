package com.longtailvideo.jwplayer.view {
	...
	public class RightclickMenu extends GlobalEventDispatcher {
		...
		protected function stretchHandler(evt:ContextMenuEvent):void {
			...
			stretching.caption = '拉伸为 ' + arr[idx] + '...';
