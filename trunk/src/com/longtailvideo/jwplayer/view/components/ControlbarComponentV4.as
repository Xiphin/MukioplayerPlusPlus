package com.longtailvideo.jwplayer.view.components {
	...
	public class ControlbarComponentV4 extends CoreComponent implements IControlbarComponent {
		...
		public function resize(width:Number, height:Number):void {
            /** 在resize时保存root矩开 **/
            rc = new Rectangle(0,0,RootReference.root.width,RootReference.root.height);
        ...
        private function isOnRoot():Boolean
        {
            /** rc矩开在resize事件中更新 **/
            return rc.contains(RootReference.stage.mouseX,RootReference.stage.mouseY);
        }
